			...
			<aside className="sidebar">
				...
				<nav>
					<ul className="nav flex-column">
						...
						<li className="nav-item mb-2">
							<button className="nav-link text-white btn btn-link p-0 text-start w-100" onClick={() => onNavigate('reportes')}>
								<i className="fa-solid fa-file me-2"></i>Reportes
							</button>
						</li>
						<li className="nav-item mt-4">
							<button className="nav-link text-white btn btn-link p-0 text-start w-100" onClick={() => onNavigate('login')}>
